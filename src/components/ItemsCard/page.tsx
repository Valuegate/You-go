...
const ItemsCard = ({ image, title, price, from, reviews }) => {
  ...
  return (
    <>
      {user && (
        <div className={`shadow-lg h-[350px] md:h-[286px] rounded-b-xl w-[250px]`}>
          ...
          <div className="flex flex-col justify-center items-start pl-4 pt-2">
            ...
            <p className="text-xs text-light-black-4 font-medium">
              By <span className="text-light-black-5 text-sm">{from}</span>
            </p>
          </div>
        </div>
      )}
