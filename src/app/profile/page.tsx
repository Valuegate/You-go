...
// import Author from "@/public/assets/Ellipse 2396.png"
...
//                   <button className="bg-gradient-to-r from-primary-1 to-primary round w-[280px] h-[50px] typo flex gap-3 items-center justify-center text-white">
