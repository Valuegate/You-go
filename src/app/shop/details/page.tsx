...
const ShopDetails = () => {
  ...
  const getSizeClass = (size: number) => {
    return clickedSize === size
      ? "text-black bg-primary-1" : "text-white bg-primary" ;
  };
      ...
      <div className="overflow-y-scroll h-[88vh]">
        <div className="px-24">
          ...
          <div className="mt-24 px-24">
            <div className="flex">
              <button className="w-48 h-12 flex justify-center items-center text-sm text-white font-bold bg-primary">Production Description</button>
              <button className="w-48 h-12 flex justify-center items-center text-sm text-black font-bold bg-white-3">Reviews</button>
            </div>
          </div>
            <hr  className="border-white-3 h-1"/>

            <div className="mt-8 w-[50%] pl-24">
          ...
          <div className="mt-8 mb-32 px-24">
