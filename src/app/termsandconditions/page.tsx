  ...
  return (
    <>
      ...
      <div className="mb-10 px-[10%]">
        <h1 className="text-xl text-primary my-4">General Terms</h1>
        <p>
          By accessing and placing an order with You Go Crafts, you confirm that
          ...
          you and You Go Crafts.
        </p>
        <p>
          Under no circumstances shall You Go Crafts team be liable for any
          ...
          You Go Crafts team or an authorized representative has been advised of
        ...
        <p>
          You Go Crafts will not be responsible for any outcome that may occur
        ...
        <h1 className="text-xl text-primary my-4">License</h1>
        <p>
          You Go Crafts grants you a revocable, non-exclusive, non-transferable,
        ...
        <h1 className="text-xl text-primary my-4">Definitions and key terms</h1>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            it refers to Egeria Desarrollo Social, El Carmen Hub C/Senador
            Francisco Román Esquina con C/ La Serna. Centro Ciudadano El Carmen,
            planta 1, local 4 29002 Málaga,Spain that is responsible for your
            information under this Terms & Conditions.
          </li>
          <li>
            Country: where You Go Crafts or the owners/founders of You Go Crafts
            are based, in this case is{" "}
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit You Go Crafts
            and use the services.
          </li>
          <li>
            Service: refers to the service provided by You Go Crafts as
          ...
          <li>
            You: a person or entity that is registered with You Go Crafts to use
            the Services.
          </li>
        </ul>

        <h1 className="text-xl text-primary my-4">Restrictions</h1>
        ...
        <ul>
          ...
          <li>
            ...
            notice of copyright or trademark) of You Go Crafts or its
            affiliates, partners, suppliers or the licensors of the website.
          </li>
        </ul>
        <h1 className="text-xl text-primary my-4">Return and Refund Policy</h1>
        <p>
          Thanks for shopping at You Go Crafts. We appreciate the fact that you
        ...
        <p>
          You Go Crafts shall be free to use, copy, modify, publish, or
        ...
        <h1 className="text-xl text-primary my-4">Links to Other Websites</h1>
        <p>
          This Terms & Conditions applies only to the Services. The Services may
          contain links to other websites not operated or controlled by You Go
          Crafts. We are not responsible for the content, accuracy or opinions
        ...
        <h1 className="text-xl text-primary my-4">Changes To Our Terms & Conditions</h1>
        <p>
          You acknowledge and agree that You Go Crafts may stop (permanently or
          ...
          do not need to specifically inform You Go Crafts when you stop using
          the Service. You acknowledge and agree that if You Go Crafts disables
        ...
        <h1 className="text-xl text-primary my-4">Modifications to Our website</h1>
        <p>
          You Go Crafts reserves the right to modify, suspend or discontinue,
        ...
        <h1 className="text-xl text-primary my-4">Updates to Our website</h1>
        <p>
        ...
        <p>
          ...
          of the website. You agree that You Go Crafts has no obligation to (i)
        ...
        <h1 className="text-xl text-primary my-4">Third-Party Services</h1>
        <p>
        ...
        <p>
          ...
          or any other aspect thereof. You Go Crafts does not assume and shall
        ...
        <p>
          This Agreement shall remain in effect until terminated by you or You
          Go Crafts.
        </p>
        <p>
          You Go Crafts may, in its sole discretion, at any time and for any or
        ...
        <p>
          ...
          You Go Crafts, in the event that you fail to comply with any provision
        ...
        <h1 className="text-xl text-primary my-4">Copyright Infringement Notice</h1>
        <p>
        ...
        <h1 className="text-xl text-primary my-4">Indemnification</h1>
        <p>
        ...
        <p>
          ...
          trade practice. Without limitation to the foregoing, You Go Crafts
        ...
        <p>
          ...
          of You Go Crafts are free of viruses, scripts, trojan horses, worms,
        ...
        <h1 className="text-xl text-primary my-4">Limitation of Liability</h1>
        <p>
          Notwithstanding any damages that you might incur, the entire liability
          of You Go Crafts and any of its suppliers under any provision of this
        ...
        <p>
          ...
          You Go Crafts or its suppliers be liable for any special, incidental,
          ...
          provision of this Agreement), even if You Go Crafts or any supplier
        ...
        <h1 className="text-xl text-primary my-4">Severability</h1>
        <p>
        ...
        <p>
          ...
          notices published by You Go Crafts on the Services, shall constitute
          the entire agreement between you and You Go Crafts concerning the
        ...
        <h1 className="text-xl text-primary my-4">Waiver</h1>
        <p>
        ...
        <h1 className="text-xl text-primary my-4">Amendments to this Agreement</h1>
        <p>
        ...
        <p>
          ...
          agree to the new terms, you are no longer authorized to use You Go
          Crafts.
        </p>

        <h1 className="text-xl text-primary my-4">Entire Agreement</h1>
        <p>
          The Agreement constitutes the entire agreement between you and You Go
          Crafts regarding your use of the website and supersedes all prior and
          contemporaneous written or oral agreements between you and You Go
          Crafts.
        </p>
        <p>
        ...
        <h1 className="text-xl text-primary my-4">Updates to Our Terms</h1>
        <p>
        ...
        <h1 className="text-xl text-primary my-4">Intellectual Property</h1>
        <p>
          The website and its entire contents, features and functionality
          (including but not limited to all information, software, text,
          displays, images, video and audio, and the design, selection and
          arrangement thereof), are owned by You Go Crafts, its licensors or
          ...
          You Go Crafts, unless and except as is expressly provided in these
