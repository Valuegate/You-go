...
export const CopyIcon = ({ color, width, height }: IconProps) => {
  return (
    <svg
      width={width ?? "24"}
      height={height ?? "24"}
    ...
    >
      ...
      />
      <path
        d="M11.98 7.14975C11.67 6.83975 11.14 7.04975 11.14 7.47975V10.0998C11.14 11.1998 12.07 12.0998 13.21 12.0998C13.92 12.1098 14.91 12.1098 15.76 12.1098C16.19 12.1098 16.41 11.6098 16.11 11.3098C15.02 10.2198 13.08 8.26975 11.98 7.14975Z"
        fill={color ?? "#080F0B"}
      />
    </svg>
  );
